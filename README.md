...
|---------------------------------------------------|-----------------------------------------------------------------------------------|----------------------------------------------------------------------|
| **Análise de vendas de Livros com Python e Power BI** | Análise sobre dados de vendas de livros entre 2023 a 2025, utilizando conceitos de EAD, Data Manipulation e Feature Engineering | [🔗 Acessar Projeto](https://github.com/MathGeneze/Analise-de-Vendas-de-Livros) |
| **Web Scraping + Aplicação Web com Python**           | Script de Extração e Limpeza dos dados dos produtos mais vendidos da Mercado Livre + APP com Filtros, Métricas e Gráficos com Streamlit  | [🔗 Acessar Projeto](https://github.com/MathGeneze/Web-Scraping-Mercado-Livre) |
